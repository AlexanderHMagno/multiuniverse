...
function App() {
  ...
  return (
    <div className="min-h-screen bg-base-100 flex flex-col md:flex-row">
      {/* Desktop Sidebar */}
      <div className="hidden md:flex flex-col w-48 bg-base-200/50 backdrop-blur-sm min-h-screen sticky top-0">
        <motion.div 
          ...
          <div className="relative w-full">
            <motion.button 
              className={`relative w-full px-3 py-2 text-left transition-colors duration-200 rounded-lg border ${
                activeTab === 'game' 
                  ? 'border-primary bg-base-100 text-primary font-bold shadow-md shadow-primary/20' 
        ...
        <div className="mt-auto p-2">
          <motion.div 
            className="badge badge-primary badge-outline gap-1 p-2 text-xs"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
      ...
      {/* Mobile Top Bar */}
      <div className="md:hidden bg-base-200/50 backdrop-blur-sm sticky top-0 z-50 p-2">
        <motion.div 
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-base-200/50 backdrop-blur-sm p-2">
